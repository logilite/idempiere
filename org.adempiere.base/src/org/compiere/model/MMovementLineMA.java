...
public class MMovementLineMA extends X_M_MovementLineMA
{
	...
	{
		this (parent, M_AttributeSetInstance_ID, M_AttributeSetInstance_ID, MovementQty, DateMaterialPolicy, DateMaterialPolicy, isAutoGenerated);
	}	//	MMovementLineMA
	 ...
	 * @param MovementQty
	 * @param DateMaterialPolicy
	 * @param DateMaterialPolicyTo
	 * @param isAutoGenerated
	 */
	public MMovementLineMA(MMovementLine parent, int M_AttributeSetInstance_ID,
			int M_AttributeSetInstanceTo_ID, BigDecimal MovementQty,
			Timestamp DateMaterialPolicy, Timestamp DateMaterialPolicyTo,
			boolean isAutoGenerated)
 {
		...
		setDateMaterialPolicyTo(DateMaterialPolicyTo);
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if(!newRecord && is_ValueChanged(COLUMNNAME_M_AttributeSetInstance_ID)){
			...
			if(getDateMaterialPolicyTo() == null)
			{
				setDateMaterialPolicyTo(getDateMaterialPolicy());
			}
		}

		if (line.getM_Locator_ID() == line.getM_LocatorTo_ID()
				&& (getM_AttributeSetInstance_ID() == getM_AttributeSetInstanceTo_ID() || (getM_AttributeSetInstance_ID() > 0 && getM_AttributeSetInstanceTo_ID() == 0)))
		{
			log.saveError(
					"Error",
		...
		if(getM_AttributeSetInstance_ID() == 0 && line.getM_AttributeSetInstance_ID() == 0)
		{
			if (product.getM_Product_ID() > 0 && product.isASIMandatory(true))
			{
				...
				{
					log.saveError("Error", "@NoAttributeSet@=" + product.getValue());
					return false;
				}
