...
public class Allocation
{
	...
	public void setInvoiceColumnClass(IMiniTable invoiceTable, boolean isMultiCurrency, boolean sameBP)
	{
		...
		if (!sameBP)
		{
			invoiceTable.setColumnClass(i++, String.class, true);       //  12-BPName
		}
		//  Table UI
	...
	public MAllocationHdr saveData(int m_WindowNo, Timestamp dateTrx, IMiniTable payment, IMiniTable invoice, String trxName)
	{
		...
		alloc.setAllocationHdrValues(true, dateTrx, C_Currency_ID, Env.getContext(Env.getCtx(), Env.AD_USER_NAME));
