...
public final class Convert_PostgreSQLTest extends TestCase{
	...
	public void testAlterColumn() {
		...
		sqe = "INSERT INTO t_alter_column values('test','T_Integer','NUMERIC(10)','NOT NULL',null,null)";
		r = convert.convert(sql);
		assertEquals(sqe, r[0]);
		...
		sqe = "INSERT INTO t_alter_column values('test','T_Integer','NUMERIC(10)','NULL',null,null)";
		r = convert.convert(sql);
		assertEquals(sqe, r[0]);
		
		sql = "ALTER TABLE Test MODIFY T_Integer NOT NULL";
		sqe = "INSERT INTO t_alter_column values('test','T_Integer',null,'NOT NULL',null,null)";
		r = convert.convert(sql);
		assertEquals(sqe, r[0]);
		...
		sqe = "INSERT INTO t_alter_column values('lpi_publication','AD_Client_ID','NUMERIC(10)',null,'NULL',null)";
        r = convert.convert(sql);
        assertEquals(sqe, r[0]);
        ...
        sqe = "INSERT INTO t_alter_column values('sometablename','someColumnName','VARCHAR(64)',null,null,null)";
        r = convert.convert(sql);
        assertEquals(sqe, r[0].trim());
        
        sql = "ALTER TABLE S_Resource MODIFY IsActive CHAR(1) DEFAULT 'Y'";
        sqe = "INSERT INTO t_alter_column values('s_resource','IsActive','CHAR(1)',null,'Y',null)";
        r = convert.convert(sql);
        assertEquals(sqe, r[0].trim());
        
        sql = "ALTER TABLE PP_Order_NodeNext MODIFY PP_Order_NodeNext_ID NULL";
        sqe = "INSERT INTO t_alter_column values('pp_order_nodenext','PP_Order_NodeNext_ID',null,'NULL',null,null)";
        r = convert.convert(sql);
        assertEquals(sqe, r[0].trim());
