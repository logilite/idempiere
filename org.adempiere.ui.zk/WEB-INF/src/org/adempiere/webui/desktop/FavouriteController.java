...
public class FavouriteController
{
	...
	public void reinit(int AD_User_ID)
	{
	...
	private void init()
	{
		...
		m_AD_Tree_Favorite_ID = MTreeFavorite.getFavoriteTreeID(m_AD_User_ID, m_AD_Role_ID);
		if (m_AD_Tree_Favorite_ID <= 0)
		{
			vTree = (MTreeFavorite) MTable.get(Env.getCtx(), MTreeFavorite.Table_ID).getPO(0, null);
			vTree.set_ValueOfColumn(I_AD_Tree_Favorite.COLUMNNAME_AD_Client_ID, Env.getAD_Client_ID(Env.getCtx()));
			vTree.setAD_Org_ID(Env.getAD_Org_ID(Env.getCtx()));
