...
/**
 * This class represents a form to share print format access with a specific user and role.
 * It extends the {@link Window} class and implements {@link EventListener<Event>} and
 * {@link ValueChangeListener}.
 * The form allows the user to grant read/write access to a print format for a particular user and
 * role.
 * 
