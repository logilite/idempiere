...
public class LoginOpenSequenceDialog extends Window
{
	...
	{
		this.AD_Tree_Favorite_ID = AD_Tree_Favorite_ID;
	...
	public void saveData()
	{
		try
		{
			...
			for (int i = 0; i < yesModel.getSize(); i++)
			{
				...
				// Set seq no
				MTreeFavoriteNode favNode = (MTreeFavoriteNode) MTable.get(Env.getCtx(), MTreeFavoriteNode.Table_ID).getPO(pp.getKey(), null);
