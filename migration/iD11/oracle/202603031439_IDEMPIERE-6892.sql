...
ALTER TABLE AD_WF_NodeNext ADD Value VARCHAR2(40 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_WF_NodeNext ADD Name VARCHAR2(60 CHAR) DEFAULT NULL 
;
...
MERGE INTO AD_WF_NodeNext nn
USING AD_WF_Node n
ON (nn.AD_WF_Next_ID = n.AD_WF_Node_ID)
WHEN MATCHED THEN
UPDATE SET
    nn.Name  = n.Name,
    nn.Value = n.Value;
