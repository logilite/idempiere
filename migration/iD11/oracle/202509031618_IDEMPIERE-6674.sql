...
ALTER TABLE AD_WF_Responsible ADD FromClause VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE AD_WF_Responsible ADD SelectClause VARCHAR2(2000 CHAR) DEFAULT NULL 
;
