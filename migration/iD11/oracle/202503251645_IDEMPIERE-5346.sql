...
-- Mar 10, 2025, 7:38:45 PM IST
CREATE TABLE AD_UserIdentity (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_User_ID NUMBER(10) NOT NULL, AD_UserIdentity_ID NUMBER(10) NOT NULL, AD_UserIdentity_UU VARCHAR2(36 CHAR) DEFAULT NULL , Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, Identity VARCHAR2(60 CHAR) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, SSO_PrincipalConfig_ID NUMBER(10) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AD_UserIdentity_Key PRIMARY KEY (AD_UserIdentity_ID), CONSTRAINT AD_UserIdentity_UU_idx UNIQUE (AD_UserIdentity_UU))
;
...
-- Mar 10, 2025, 8:13:43 PM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (203999,0,0,'Y',TO_TIMESTAMP('2025-03-10 20:13:41','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2025-03-10 20:13:41','YYYY-MM-DD HH24:MI:SS'),100,'IsHasUserIdentity','Has User Identity','Has User Identity','D','146ef8e2-007b-41b1-b215-8ca60c55b79d')
;

-- Mar 10, 2025, 8:14:02 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,DefaultValue,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,ColumnSQL,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml,IsDisableZoomAcross,IsPartitionKey) VALUES (217086,0,'Has User Identity',114,'IsHasUserIdentity','N',1,'N','N','Y','N','N',0,'N',20,0,0,'Y',TO_TIMESTAMP('2025-03-10 20:14:01','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2025-03-10 20:14:01','YYYY-MM-DD HH24:MI:SS'),100,203999,'N','N','D','N','N','(CASE 
        WHEN (SELECT COUNT(1) FROM SSO_PrincipalConfig WHERE IsActive = ''Y'') > 0 
        THEN ''Y'' 
        ELSE ''N'' 
    END)','N','Y','ef14671b-5406-4e02-b81a-2f0574e18669','N',0,'N','N','N','N','N')
;

-- Mar 10, 2025, 8:14:14 PM IST
UPDATE AD_Tab SET DisplayLogic='@IsHasUserIdentity@=Y',Updated=TO_TIMESTAMP('2025-03-10 20:14:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200392
;

-- Mar 10, 2025, 8:14:43 PM IST
INSERT INTO AD_Field (AD_Field_ID,Name,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,XPosition,ColumnSpan) VALUES (208755,'Has User Identity',118,217086,'Y',1,590,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2025-03-10 20:14:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2025-03-10 20:14:43','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','56269b55-d8c3-408c-9b80-584bf0fbddb9','Y',3160,2,2)
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=310,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200072
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=320,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=6513
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=330,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11525
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=340,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202876
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=350,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202875
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=360,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=6520
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=370,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=8342
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=380,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=6519
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=390,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200400
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=400,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200405
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=410,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200406
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=420,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200474
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=430,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=205827
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=440,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200403
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=450,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200401
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=460,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200402
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=470,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207598
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=480,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208734
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=490,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208735
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=500,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208736
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=510,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208737
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=520,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208738
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208728
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208733
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET IsDisplayed='N', SeqNo=0, XPosition=1,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208755
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208729
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208731
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208730
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208732
;

-- Mar 10, 2025, 8:14:58 PM IST
UPDATE AD_Field SET SeqNo=0,Updated=TO_TIMESTAMP('2025-03-10 20:14:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=208727
;
