...
ALTER TABLE AD_WF_Node ADD COLUMN IsShowTransitionsAsAction CHAR(1) DEFAULT 'N' CHECK (IsShowTransitionsAsAction IN ('Y','N')) NOT NULL
;
...
UPDATE AD_Field SET DisplayLogic='@Action@=V | @Action@=C | @Action@=U ', ReadOnlyLogic='@Action@=C | @Action@=U  & @IsShowTransitionsAsAction@=Y',Updated=TO_TIMESTAMP('2026-03-19 15:31:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10088
;
