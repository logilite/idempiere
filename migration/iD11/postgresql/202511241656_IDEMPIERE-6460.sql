...
ALTER TABLE AD_WF_Node_Var ADD COLUMN DisplayLogic VARCHAR(2000) DEFAULT NULL 
;
...
ALTER TABLE AD_WF_Node_Var ADD COLUMN MandatoryLogic VARCHAR(2000) DEFAULT NULL 
;
