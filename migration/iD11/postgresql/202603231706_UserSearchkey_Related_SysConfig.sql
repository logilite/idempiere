...
INSERT INTO AD_SysConfig (AD_SysConfig_ID,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive,Name,Value,Description,EntityType,ConfigurationLevel,AD_SysConfig_UU) VALUES (200304,0,0,TO_TIMESTAMP('2026-03-23 17:06:21','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2026-03-23 17:06:21','YYYY-MM-DD HH24:MI:SS'),100,100,'Y','USER_SEARCHKEY_CASE','N','U-If want to set upper case Search Key on User,
