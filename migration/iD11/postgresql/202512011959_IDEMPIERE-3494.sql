-- #3494: Add Account Date column on Project Issue table
SELECT register_migration_script('202512011959_IDEMPIERE-3494.sql') FROM dual;
...
ALTER TABLE C_ProjectIssue ADD COLUMN DateAcct TIMESTAMP DEFAULT NULL 
;
