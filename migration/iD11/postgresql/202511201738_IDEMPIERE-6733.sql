...
-- Nov 20, 2025, 5:40:12 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml,IsPartitionKey) VALUES (217169,0,'Document Type','Document type or rules','The Document Type determines document sequence and processing rules',545,'C_DocType_ID',22,'N','N','N','N','N',0,'N',19,0,0,'Y',TO_TIMESTAMP('2025-11-20 17:40:11','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2025-11-20 17:40:11','YYYY-MM-DD HH24:MI:SS'),100,196,'N','N','D','N','N','N','Y','019aa12c-1622-7d38-a1ef-9b7257538e14','Y',0,'N','N','N','N')
;

-- Nov 20, 2025, 5:40:14 PM IST
UPDATE AD_Column SET FKConstraintName='CDocType_TReportStatement', FKConstraintType='N',Updated=TO_TIMESTAMP('2025-11-20 17:40:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=217169
;

-- Nov 20, 2025, 5:40:14 PM IST
ALTER TABLE T_ReportStatement ADD COLUMN C_DocType_ID NUMERIC(10) DEFAULT NULL 
;

-- Nov 20, 2025, 5:40:14 PM IST
ALTER TABLE T_ReportStatement ADD CONSTRAINT CDocType_TReportStatement FOREIGN KEY (C_DocType_ID) REFERENCES c_doctype(c_doctype_id) DEFERRABLE INITIALLY DEFERRED
;
...
-- Nov 20, 2025, 5:42:33 PM IST
INSERT INTO AD_PrintFormatItem (SeqNo,Name,Created,IsNextLine,AD_Client_ID,PrintName,YSpace,SortNo,AD_Column_ID,IsPageBreak,IsRelativePosition,UpdatedBy,MaxWidth,AD_PrintFormatItem_ID,CreatedBy,IsSummarized,YPosition,AD_PrintColor_ID,Updated,AD_PrintFormat_ID,AD_Org_ID,XSpace,AD_PrintFont_ID,IsActive,IsHeightOneLine,MaxHeight,XPosition,FieldAlignmentType,IsPrinted,IsOrderBy,IsGroupBy,LineAlignmentType,PrintFormatType,PrintAreaType,ImageIsAttached,IsCounted,IsAveraged,IsSuppressNull,IsSetNLPosition,BelowColumn,IsNextPage,IsFixedWidth,IsMaxCalc,RunningTotalLines,IsRunningTotal,IsMinCalc,IsVarianceCalc,IsDeviationCalc,IsFilledRectangle,LineWidth,ArcDiameter,ShapeType,IsCentrallyMaintained,IsImageField,IsSuppressRepeats,AD_PrintFormatItem_UU,IsDesc,IsPrintBarcodeText,IsPrintInstanceAttributes) VALUES (100,'Document Type',TO_TIMESTAMP('2025-11-20 17:42:32','YYYY-MM-DD HH24:MI:SS'),'Y',0,'Document Type',0,0,217169,'N','Y',100,0,200536,100,'N',0,100,TO_TIMESTAMP('2025-11-20 17:42:32','YYYY-MM-DD HH24:MI:SS'),134,0,0,130,'Y','Y',0,0,'D','Y','N','N','X','F','C','N','N','N','N','N',0,'N','N','N',20,'N','N','N','N','N',1,0,'N','N','N','N','019aa12e-3cf4-7a82-b5b3-8acf5bafb78f','N','Y','N')
;
...
-- Nov 20, 2025, 5:44:50 PM IST
UPDATE AD_PrintFormatItem SET SeqNo=60, SortNo=0, IsPageBreak='N', YPosition=0, XPosition=0, IsPrinted='Y', IsGroupBy='N',Updated=TO_TIMESTAMP('2025-11-20 17:44:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_PrintFormatItem_ID=200536
;
