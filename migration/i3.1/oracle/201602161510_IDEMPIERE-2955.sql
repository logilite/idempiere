...
ALTER TABLE M_AttributeSet ADD COLUMN M_AttributeSet_Type VARCHAR2(3) DEFAULT 'MMS' 
;
...
SELECT register_migration_script('201602161510_IDEMPIERE-2955') FROM dual
;