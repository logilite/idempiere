...
INSERT INTO AD_Message (MsgType,MsgText,AD_Message_ID,EntityType,AD_Message_UU,Value,IsActive,Updated,CreatedBy,UpdatedBy,Created,AD_Client_ID,AD_Org_ID) VALUES ('I','SQL must not update or insert record.',200259,'U','49c3be7e-16de-46ff-a2a9-f9411a6a4982','SQLReadOnly','Y',TO_DATE('2014-03-19 17:45:57','YYYY-MM-DD HH24:MI:SS'),100,100,TO_DATE('2014-03-19 17:45:57','YYYY-MM-DD HH24:MI:SS'),0,0)
;

-- Mar 19, 2014 5:47:52 PM IST
UPDATE AD_Column SET IsMandatory='N', MandatoryLogic='@Operation@!''SQ''',Updated=TO_DATE('2014-03-19 17:47:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=11579
;
