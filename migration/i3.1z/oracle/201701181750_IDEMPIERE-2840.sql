...
INSERT INTO AD_SysConfig (AD_SysConfig_ID,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive,Name,Value,EntityType,ConfigurationLevel,AD_SysConfig_UU) VALUES (200085,0,0,TO_DATE('2017-01-18 17:51:38','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2017-01-18 17:51:38','YYYY-MM-DD HH24:MI:SS'),100,100,'Y','WEBSERVICE_TOKEN_CHECK_CLIENT','Y','D','S','05599162-1b8d-4691-a5ed-df79282a798a')
;
