...
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,ColumnSpan) VALUES (203867,'Date  Material Policy To','Time used for LIFO and FIFO Material Policy','This field is used to record time used for LIFO and FIFO material policy',750,212227,'Y',7,90,'N','N','N','N',0,0,'Y',TO_DATE('2015-09-18 18:34:28','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2015-09-18 18:34:28','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','48c0904f-1a85-4a9b-a209-269f4605e542','Y',70,2)
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, XPosition=4,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=12191
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=50, XPosition=1,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=12188
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=60, XPosition=4,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=203866
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=70, XPosition=1,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202288
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=80, XPosition=4,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=203867
;

-- Sep 18, 2015 6:36:03 PM IST
UPDATE AD_Field SET SeqNo=90,Updated=TO_DATE('2015-09-18 18:36:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=202881
;

-- Oct 14, 2015 5:26:24 PM IST
ALTER TABLE M_MovementLineMA ADD DateMaterialPolicyTo DATE DEFAULT NULL 
;

-- Oct 14, 2015 5:26:41 PM IST
UPDATE AD_Column SET IsMandatory='Y', IsUpdateable='N',Updated=TO_DATE('2015-10-14 17:26:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=210651
;

-- Oct 14, 2015 5:26:46 PM IST
ALTER TABLE M_MovementLineMA MODIFY DateMaterialPolicy DATE
;
