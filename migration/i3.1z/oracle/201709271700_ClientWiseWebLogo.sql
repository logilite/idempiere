...
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (203138,0,0,'Y',TO_DATE('2017-09-22 12:38:46','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2017-09-22 12:38:46','YYYY-MM-DD HH24:MI:SS'),100,'LogoWebHeader_ID','Logo Web Header','Logo Web Header','D','10649799-238b-47bd-bb0c-cb53224fb2a5')
;

-- Sep 22, 2017 12:39:11 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (213253,0,'Logo Web Header',227,'LogoWebHeader_ID',10,'N','N','N','N','N',0,'N',32,0,0,'Y',TO_DATE('2017-09-22 12:39:10','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2017-09-22 12:39:10','YYYY-MM-DD HH24:MI:SS'),100,203138,'Y','N','D','N','N','N','Y','909240c5-646a-44f5-bb4a-21b41047f9af','Y',0,'N','N')
;

-- Sep 22, 2017 12:39:15 PM IST
UPDATE AD_Column SET FKConstraintName='LogoWebHeader_ADClientInfo', FKConstraintType='N',Updated=TO_DATE('2017-09-22 12:39:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=213253
;

-- Sep 22, 2017 12:39:16 PM IST
ALTER TABLE AD_ClientInfo ADD LogoWebHeader_ID NUMBER(10) DEFAULT NULL 
;
