...
INSERT INTO AD_Field (AD_Field_ID,Name,Description,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,ColumnSpan) VALUES (203497,'M_InOutLineMA_ID','Attributes',751,211836,'N',22,'N','N','N','N',0,0,'Y',TO_DATE('2015-02-06 15:03:32','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2015-02-06 15:03:32','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','33f6eae8-2b4a-4e55-a772-dcdffe183c3b','N',2)
;

-- Feb 6, 2015 3:04:09 PM IST
UPDATE AD_Column SET IsParent='N',Updated=TO_DATE('2015-02-06 15:04:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=13323
;

-- Feb 6, 2015 3:04:16 PM IST
UPDATE AD_Column SET IsParent='N',Updated=TO_DATE('2015-02-06 15:04:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=13322
;

-- Feb 6, 2015 3:04:21 PM IST
ALTER TABLE M_InOutLineMA MODIFY M_AttributeSetInstance_ID NUMBER(10)
;
...
ALTER TABLE M_InOutLineMA MODIFY M_InOutLine_ID NUMBER(10)
;
