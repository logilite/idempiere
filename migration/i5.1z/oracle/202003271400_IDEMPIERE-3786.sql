...
-- IDEMPIERE-3786 Added Grid View and detail view page size config at tab level
-- Mar 20, 2020 4:26:00 PM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,Description,PrintName,EntityType,AD_Element_UU) VALUES (203408,0,0,'Y',TO_DATE('2020-03-20 16:25:59','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-20 16:25:59','YYYY-MM-DD HH24:MI:SS'),100,'PageSize','Page Size','Page size of the tab in the grid view','Page Size','D','632ee294-53ef-4986-be72-42c8fd05891a')
;

-- Mar 20, 2020 4:27:32 PM IST
UPDATE AD_Element SET ColumnName='PageSize',Updated=TO_DATE('2020-03-20 16:27:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=203408
;
...
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (214188,0,'Page Size','Page size of the tab in the grid view',106,'PageSize',10,'N','N','N','N','N',0,'N',22,0,0,'Y',TO_DATE('2020-03-20 16:30:55','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-20 16:30:55','YYYY-MM-DD HH24:MI:SS'),100,203408,'Y','N','D','N','N','N','Y','bae50c7f-ecda-48a4-a367-e99d507014d1','Y',0,'N','N')
;

-- Mar 20, 2020 4:31:02 PM IST
ALTER TABLE AD_Tab ADD PageSize NUMBER DEFAULT NULL 
;

-- Mar 20, 2020 4:31:11 PM IST
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_DATE('2020-03-20 16:31:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=214188
;

-- Mar 20, 2020 4:32:42 PM IST
INSERT INTO AD_Field (AD_Field_ID,Name,Description,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,SortNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField,IsQuickForm) VALUES (206396,'Page Size','Page size of the tab in the grid view',106,214188,'Y',0,345,0,'N','N','N','N',0,0,'Y',TO_DATE('2020-03-20 16:32:41','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-20 16:32:41','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','a7ad9c45-a08a-4f2c-801f-207b96f48aa1','Y',315,4,1,1,'N','N','N','N')
;

-- Mar 27, 2020 3:06:57 PM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,Description,PrintName,EntityType,AD_Element_UU) VALUES (203409,0,0,'Y',TO_DATE('2020-03-27 15:06:57','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-27 15:06:57','YYYY-MM-DD HH24:MI:SS'),100,'DetailPageSize','Detail Page Size','Page size of the tab in the detail view','Detail Page Size','D','775434d2-87b4-4e36-b5e1-da9b17eddc14')
;

-- Mar 27, 2020 3:48:53 PM IST
ALTER TABLE AD_Tab ADD DetailPageSize NUMBER DEFAULT NULL 
;

-- Mar 27, 2020 3:08:06 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (214189,0,'Detail Page Size','Page size of the tab in the detail view',106,'DetailPageSize',22,'N','N','N','N','N',0,'N',22,0,0,'Y',TO_DATE('2020-03-27 15:08:06','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-27 15:08:06','YYYY-MM-DD HH24:MI:SS'),100,203409,'Y','N','D','N','Y','N','Y','8b9ed62e-7971-434a-af5a-d36973c71518','Y',0,'N','N')
;

-- Mar 27, 2020 3:17:27 PM IST
INSERT INTO AD_Field (AD_Field_ID,Name,Description,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,SortNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField,IsQuickForm) VALUES (206397,'Detail Page Size','Page size of the tab in the detail view',106,214189,'Y',0,346,0,'N','N','N','N',0,0,'Y',TO_DATE('2020-03-27 15:17:27','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2020-03-27 15:17:27','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','d940be3e-16a6-4b91-a1d5-ff441746251c','Y',315,4,1,1,'N','N','N','N')
;

-- Mar 27, 2020 3:20:51 PM IST
UPDATE AD_Field SET AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=1, IsToolbarButton=NULL,Updated=TO_DATE('2020-03-27 15:20:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206396
;

-- Mar 27, 2020 6:56:54 PM IST
UPDATE AD_Field SET DisplayLogic='@TabLevel@ > 0', AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_DATE('2020-03-27 18:56:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206397
;
