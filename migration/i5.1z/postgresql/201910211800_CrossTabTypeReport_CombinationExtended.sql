...
INSERT INTO t_alter_column values('pa_reportsource','PA_ReportLine_ID','NUMERIC(10)',null,'NULL',null)
;

-- Oct 21, 2019 6:28:26 PM IST
INSERT INTO t_alter_column values('pa_reportsource','PA_ReportLine_ID',null,'NULL',null,null)
;
...
SELECT register_migration_script('201910211800_CrossTabTypeReport_CombinationExtended.sql') FROM dual
;
