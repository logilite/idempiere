...
INSERT INTO AD_Field (AD_Field_ID,Name,Description,Help,AD_Tab_ID,AD_Column_ID,IsDisplayed,DisplayLength,SeqNo,IsSameLine,IsHeading,IsFieldOnly,IsEncrypted,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,IsReadOnly,IsCentrallyMaintained,EntityType,AD_Field_UU,IsDisplayedGrid,SeqNoGrid,XPosition,ColumnSpan,NumLines,IsQuickEntry,IsDefaultFocus,IsAdvancedField,IsQuickForm) VALUES (203940,'Active','The record is active in the system','There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports.
		...
		(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200198,212326,'Y',1,50,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2019-12-04 18:47:08','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-12-04 18:47:08','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','ba915a52-00ad-43c8-9527-69e0e41436e1','Y',40,2,2,1,'N','N','N','N')
;

-- Dec 4, 2019 6:05:17 PM IST
INSERT INTO AD_Element (AD_Element_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,ColumnName,Name,PrintName,EntityType,AD_Element_UU) VALUES (203391,0,0,'Y',TO_TIMESTAMP('2019-12-04 18:05:16','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-12-04 18:05:16','YYYY-MM-DD HH24:MI:SS'),100,'C_ContactActivity_Attendees_UU','C_ContactActivity_Attendees_UU','C_ContactActivity_Attendees_UU','D','2c562742-53aa-4781-bba0-b91bfae2639e')
;

-- Dec 4, 2019 6:06:11 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure) VALUES (214128,0,'C_ContactActivity_Attendees_UU',200182,'C_ContactActivity_Attendees_UU',36,'N','N','N','N','N',0,'N',10,0,0,'Y',TO_TIMESTAMP('2019-12-06 18:01:24','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2019-12-06 18:01:24','YYYY-MM-DD HH24:MI:SS'),100,203391,'Y','N','D','N','N','N','Y','75130958-6259-4135-8fa5-5471fbffed23','N',0,'N','N')
;
-- Dec 4, 2019 6:06:14 PM IST
ALTER TABLE C_ContactActivity_Attendees ADD COLUMN C_ContactActivity_Attendees_UU VARCHAR(36) DEFAULT NULL 
;
