...
UPDATE AD_Tab SET EntityType='D',Updated=TO_TIMESTAMP('2019-06-22 15:56:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200269
;
...
UPDATE AD_Field SET EntityType='D',Updated=TO_TIMESTAMP('2019-06-22 15:57:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206125
;

-- Jun 22, 2019, 3:57:10 PM BRT
UPDATE AD_Field SET EntityType='D', AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2019-06-22 15:57:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=206126
;
...
UPDATE AD_Element SET EntityType='D',Updated=TO_TIMESTAMP('2019-06-22 16:02:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=203344
;
...
c.ad_chart_id, f.ad_labelstyle_id, f.ad_fieldstyle_id, c.pa_dashboardcontent_id, f.isquickform, COALESCE(f.placeholder, c.placeholder) AS placeholder, f.entitytype, COALESCE(f.ad_val_rule_Lookup_id, c.ad_val_rule_Lookup_id) AS ad_val_rule_Lookup_id, vrf.code AS validationcodeLookup
   FROM ad_field f
