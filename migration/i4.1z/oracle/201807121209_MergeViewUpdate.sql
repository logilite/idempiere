...
(AD_TAB_ID, AD_WINDOW_ID, AD_TABLE_ID, NAME, DESCRIPTION, 
 ...
 INCLUDED_TAB_ID, PARENT_COLUMN_ID, AD_Tab_UU, AD_Table_UU, TREEDISPLAYEDON, AD_TabType)
AS 
...
SELECT register_migration_script('201807121209_MergeViewUpdate.sql') FROM dual
;
