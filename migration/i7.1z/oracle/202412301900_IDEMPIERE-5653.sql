...
OR NOT EXISTS (SELECT 1 FROM AD_PrintFormat_Access WHERE AD_PrintFormat_ID = AD_PrintFormat.AD_PrintFormat_ID) ',Updated=TO_DATE('2024-12-30 19:26:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=200189
;

-- Dec 30, 2024, 8:00:46 PM IST
UPDATE AD_Process_Para SET AD_Val_Rule_ID=NULL,Updated=TO_DATE('2024-12-30 20:00:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=200482
;
