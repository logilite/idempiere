...
INSERT INTO AD_Tab (AD_Tab_ID,Name,AD_Window_ID,SeqNo,IsSingleRow,AD_Table_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,HasTree,IsInfoTab,IsTranslationTab,IsReadOnly,AD_Column_ID,Processing,ImportFields,TabLevel,IsSortTab,EntityType,IsInsertRecord,IsAdvancedTab,AD_Tab_UU,TreeDisplayedOn,IsLookupOnlySelection,IsAllowAdvancedLookup,MaxQueryRecords,PageSize,DetailPageSize) VALUES (200297,'Document Status Access',108,100,'Y',200278,0,0,'Y',TO_DATE('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2021-06-28 22:04:19','YYYY-MM-DD HH24:MI:SS'),100,'N','N','N','N',214531,'N','N',1,'N','D','Y','N','5dc2b3d5-02ef-4231-a9f3-3ebdfa35c445','B','N','Y',0,0,0)
;
