...
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly,IsHideInfoColumn,IsMultiSelectCriteria) VALUES (200231,0,0,'Y',TO_DATE('2022-07-04 19:16:58','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2022-07-04 19:16:58','YYYY-MM-DD HH24:MI:SS'),100,'Bank Account','Account at the Bank','The Bank Account identifies an account at this Bank.',200020,'D','a.C_BankAccount_ID',30,'Y','N',836,19,'6f1fa8aa-551c-48b0-9b14-d04a1df6bae6','Y','C_BankAccount_ID','N',0,'N','N','Y','N','N')
;

-- 04-Jul-2022, 7:17:00 PM IST
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,IsCentrallyMaintained,ColumnName,QueryOperator,QueryFunction,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly,IsHideInfoColumn,IsMultiSelectCriteria) VALUES (200232,0,0,'Y',TO_DATE('2022-07-04 19:16:59','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2022-07-04 19:16:59','YYYY-MM-DD HH24:MI:SS'),100,'Deposit Date',200020,'D','a.DateDeposit',40,'Y','Y',202197,15,'f9df0759-b0b4-4f97-b792-d738507d5bdd','Y','DateDeposit','=','Trunc','Y',10,'N','N','Y','N','N')
;

-- 04-Jul-2022, 7:17:00 PM IST
INSERT INTO AD_InfoColumn (AD_InfoColumn_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_InfoWindow_ID,EntityType,SelectClause,SeqNo,IsDisplayed,IsQueryCriteria,AD_Element_ID,AD_Reference_ID,AD_InfoColumn_UU,AD_Val_Rule_ID,IsCentrallyMaintained,ColumnName,IsIdentifier,SeqNoSelection,IsMandatory,IsKey,IsReadOnly,IsHideInfoColumn,IsMultiSelectCriteria) VALUES (200233,0,0,'Y',TO_DATE('2022-07-04 19:17:00','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2022-07-04 19:17:00','YYYY-MM-DD HH24:MI:SS'),100,'Document Type','Document type or rules','The Document Type determines document sequence and processing rules',200020,'D','a.C_DocType_ID',50,'Y','N',196,19,'cfebd86d-1a33-40dd-899c-a61902785694',149,'Y','C_DocType_ID','N',0,'N','N','Y','N','N')
;
