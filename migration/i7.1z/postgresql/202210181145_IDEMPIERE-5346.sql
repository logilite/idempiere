...
INSERT INTO t_alter_column values('sso_principleconfig','SSO_ApplicationClientID','VARCHAR(100)',null,'NULL',null)
;

-- Oct 19, 2022, 3:54:46 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_ApplicationClientID',null,'NULL',null,null)
;

-- Oct 19, 2022, 3:54:58 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_ApplicationLogoutURL','VARCHAR(1000)',null,'NULL',null)
;

-- Oct 19, 2022, 3:55:09 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_ApplicationRedirectURIs','VARCHAR(1000)',null,'NULL',null)
;

-- Oct 19, 2022, 3:55:22 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_ApplicationSecretKey','VARCHAR(100)',null,'NULL',null)
;

-- Oct 19, 2022, 3:55:28 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_AuthorizationTenantID','VARCHAR(100)',null,'NULL',null)
;

-- Oct 19, 2022, 3:55:28 PM IST
INSERT INTO t_alter_column values('sso_principleconfig','SSO_AuthorizationTenantID',null,'NULL',null,null)
;

SELECT register_migration_script('202210181145_IDEMPIERE-5346.sql') FROM dual
;
