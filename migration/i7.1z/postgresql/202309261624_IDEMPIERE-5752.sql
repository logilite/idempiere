...
-- Sep 26, 2023, 4:25:00 PM IST
ALTER TABLE PA_ReportLine ADD COLUMN DimensionGroup VARCHAR(2) DEFAULT NULL 
;
...
-- Sep 26, 2023, 4:25:01 PM IST
ALTER TABLE PA_ReportSource ADD COLUMN DimensionGroup VARCHAR(2) DEFAULT NULL 
;
...
-- Sep 26, 2023, 4:25:03 PM IST
ALTER TABLE T_Report ADD COLUMN DimensionGroupRecord_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Sep 26, 2023, 4:25:04 PM IST
ALTER TABLE T_Report ADD COLUMN DimensionGroupName VARCHAR(60) DEFAULT NULL 
;
