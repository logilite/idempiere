...
For customizations, copy the entity and select "User"!',563,'EntityType','@SQL=select get_sysconfig(''DEFAULT_ENTITYTYPE'',''U'',0,0) from dual',40,'N','N','N','N','N',0,'N',18,389,0,0,'Y',TO_TIMESTAMP('2023-12-27 14:36:50','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-12-27 14:36:50','YYYY-MM-DD HH24:MI:SS'),100,1682,'Y','N','@EntityType@=D','D','N','N','N','Y','bfdc9b7c-89ba-475a-9bf4-2fcc5185584a','Y',0,'N','N','N','N','N')
;
...
For customizations, copy the entity and select "User"!',562,'EntityType','@SQL=select get_sysconfig(''DEFAULT_ENTITYTYPE'',''U'',0,0) from dual',40,'N','N','N','N','N',0,'N',18,389,0,0,'Y',TO_TIMESTAMP('2023-12-27 14:38:20','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-12-27 14:38:20','YYYY-MM-DD HH24:MI:SS'),100,1682,'Y','N','@EntityType@=D','D','N','N','N','Y','6d07a1a8-67f5-48fa-90b0-ee9bdf62a308','Y',0,'N','N','N','N','N')
;
