...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200391,'IsActive','Y',1,'N','N','N','N','N',0,'N',20,0,0,'Y',TO_TIMESTAMP('2023-10-09 13:33:03','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-10-09 13:33:03','YYYY-MM-DD HH24:MI:SS'),100,348,'Y','N','D','N','N','N','Y','c0511c22-f366-4df3-b19c-38d352e7d934','N',0,'N','N','N')
;

-- Oct 9, 2023, 1:33:20 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,DefaultValue,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,IsHtml) VALUES (215959,0,'Updated','Date this record was updated','The Updated field indicates the date that this record was updated.',200391,'Updated','SYSDATE',7,'N','N','N','N','N',0,'N',16,0,0,'Y',TO_TIMESTAMP('2023-10-09 13:33:19','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-10-09 13:33:19','YYYY-MM-DD HH24:MI:SS'),100,607,'N','N','D','N','N','N','Y','65d2f523-fba0-44b6-8dd2-7f45bd74e60c','N',0,'N','N','N')
;

-- Oct 9, 2023, 1:33:50 PM IST
INSERT INTO AD_Column (AD_Column_ID,Version,Name,Description,Help,AD_Table_ID,ColumnName,FieldLength,IsKey,IsParent,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsEncrypted,AD_Reference_ID,AD_Reference_Value_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Element_ID,IsUpdateable,IsSelectionColumn,EntityType,IsSyncDatabase,IsAlwaysUpdateable,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsAllowCopy,SeqNoSelection,IsToolbarButton,IsSecure,FKConstraintType,IsHtml) VALUES (215960,0,'Updated By','User who updated this records','The Updated By field indicates the user who updated this record.',200391,'UpdatedBy',22,'N','N','N','N','N',0,'N',18,110,0,0,'Y',TO_TIMESTAMP('2023-10-09 13:33:49','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-10-09 13:33:49','YYYY-MM-DD HH24:MI:SS'),100,608,'N','N','D','N','N','N','Y','32b91b1a-8000-49f0-a517-6ff2e38164aa','N',0,'N','N','D','N')
;

-- Oct 9, 2023, 1:34:24 PM IST
UPDATE AD_Column SET IsUpdateable='Y',Updated=TO_TIMESTAMP('2023-10-09 13:34:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215954
;

-- Oct 9, 2023, 1:34:33 PM IST
UPDATE AD_Column SET IsUpdateable='Y', IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2023-10-09 13:34:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215955
;

-- Oct 9, 2023, 1:34:39 PM IST
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2023-10-09 13:34:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215954
;

-- Oct 9, 2023, 1:35:00 PM IST
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2023-10-09 13:35:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215953
;

-- Oct 9, 2023, 1:35:08 PM IST
UPDATE AD_Column SET FKConstraintName='ADPrintFormat_ADPrintFormatAcc', FKConstraintType='N',Updated=TO_TIMESTAMP('2023-10-09 13:35:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215953
;

-- Oct 9, 2023, 1:35:08 PM IST
UPDATE AD_Column SET FKConstraintName='ADRole_ADPrintFormatAccess', FKConstraintType='C',Updated=TO_TIMESTAMP('2023-10-09 13:35:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215954
;

-- Oct 9, 2023, 1:35:08 PM IST
UPDATE AD_Column SET FKConstraintName='ADUser_ADPrintFormatAccess', FKConstraintType='N',Updated=TO_TIMESTAMP('2023-10-09 13:35:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215955
;

-- Oct 9, 2023, 1:35:08 PM IST
CREATE TABLE AD_PrintFormat_Access (AD_Client_ID NUMERIC(10) DEFAULT NULL , AD_Org_ID NUMERIC(10) DEFAULT NULL , AD_PrintFormat_Access_ID NUMERIC(10) DEFAULT NULL , AD_PrintFormat_Access_UU VARCHAR(36) DEFAULT NULL , AD_PrintFormat_ID NUMERIC(10) DEFAULT NULL , AD_Role_ID NUMERIC(10) DEFAULT NULL , AD_User_ID NUMERIC(10) DEFAULT NULL , Created TIMESTAMP DEFAULT statement_timestamp(), CreatedBy NUMERIC(10) DEFAULT NULL , IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')), Updated TIMESTAMP DEFAULT statement_timestamp(), UpdatedBy NUMERIC(10) DEFAULT NULL , CONSTRAINT AD_PrintFormat_Access_Key PRIMARY KEY (AD_PrintFormat_Access_ID), CONSTRAINT AD_PrintFormat_Access_UU_idx UNIQUE (AD_PrintFormat_Access_UU))
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.',200357,215958,'Y',1,60,'N','N','N','N',0,0,'Y',TO_TIMESTAMP('2023-10-09 14:51:23','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2023-10-09 14:51:23','YYYY-MM-DD HH24:MI:SS'),100,'N','Y','D','ed568055-63ec-41c3-b380-a6f5bd987eac','Y',50,2,2)
;

-- Oct 9, 2023, 2:51:48 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=40, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=5, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-10-09 14:51:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207757
;

-- Oct 9, 2023, 2:51:48 PM IST
UPDATE AD_Field SET SeqNo=50, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-10-09 14:51:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207755
;

-- Oct 9, 2023, 2:51:48 PM IST
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=60, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, XPosition=4, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-10-09 14:51:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207756
;

-- Oct 9, 2023, 2:51:48 PM IST
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-10-09 14:51:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207753
;

-- Oct 9, 2023, 2:51:48 PM IST
UPDATE AD_Field SET SeqNo=0, AD_Reference_Value_ID=NULL, AD_Val_Rule_ID=NULL, IsToolbarButton=NULL,Updated=TO_TIMESTAMP('2023-10-09 14:51:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=207752
;

-- Dec 18, 2023, 1:52:10 PM IST
UPDATE AD_Column SET DefaultValue='@AD_PrintFormat_ID@', IsParent='Y', IsUpdateable='N', IsAlwaysUpdateable='N',Updated=TO_TIMESTAMP('2023-12-18 13:52:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=215953
;

-- Apr 22, 2024, 4:43:47 PM IST
INSERT INTO AD_Process (AD_Process_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,IsReport,Value,IsDirectPrint,Classname,AccessLevel,EntityType,Statistic_Count,Statistic_Seconds,IsBetaFunctionality,IsServerProcess,ShowHelp,CopyFromProcess,AD_Process_UU,AllowMultipleExecution,IsPrinterPreview) VALUES (200163,0,0,'Y',TO_TIMESTAMP('2024-04-22 16:43:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2024-04-22 16:43:43','YYYY-MM-DD HH24:MI:SS'),100,'Share Print Format','N','harePrintFormat','N','org.adempiere.process.SharePrintFormat','3','D',0,0,'N','N','Y','N','0955112b-75e0-4087-9346-4b12a5270cf1','P','N')
;

-- Apr 22, 2024, 4:45:32 PM IST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (200480,0,0,'Y',TO_TIMESTAMP('2024-04-22 16:45:28','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2024-04-22 16:45:28','YYYY-MM-DD HH24:MI:SS'),100,'User/Contact','User within the system - Internal or Business Partner Contact','The User identifies a unique user in the system. This could be an internal user or a business partner contact',200163,10,18,'N',0,'N','AD_User_ID','Y','D',138,'40c3a093-56cd-42ea-be9f-ec269de92e4a','N')
;

-- Apr 22, 2024, 4:45:58 PM IST
INSERT INTO AD_Process_Para (AD_Process_Para_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,Name,Description,Help,AD_Process_ID,SeqNo,AD_Reference_ID,IsRange,FieldLength,IsMandatory,ColumnName,IsCentrallyMaintained,EntityType,AD_Element_ID,AD_Process_Para_UU,IsEncrypted) VALUES (200481,0,0,'Y',TO_TIMESTAMP('2024-04-22 16:45:57','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2024-04-22 16:45:57','YYYY-MM-DD HH24:MI:SS'),100,'Role','Responsibility Role','The Role determines security and access a user who has this Role will have in the System.',200163,20,18,'N',0,'N','AD_Role_ID','Y','D',123,'18797e6c-5494-4695-b8eb-3afb6ffed6d2','N')
;

-- Apr 22, 2024, 6:44:47 PM IST
UPDATE AD_Tab SET DisplayLogic='@#AD_Client_ID@=0',Updated=TO_TIMESTAMP('2024-04-22 18:44:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=200357
;

-- Apr 23, 2024, 5:58:58 PM IST
